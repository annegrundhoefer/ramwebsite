	...
	<div class="container">
		<div class="row">
			<div class="col-sm-4 blinds">
				...
				<a href="<?php bloginfo('template_url'); ?>/blinds"><div class="btn btn-primary">View all</div></a>
			</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-4 col-sm-offset-2 shutters">
				...
				<a href="<?php bloginfo('template_url'); ?>/shutters"><div class="btn btn-primary red">View all</div></a>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-4 blinds">
				...
				<a href="<?php bloginfo('template_url'); ?>/window-treatments"><div class="btn btn-primary">View all</div></a>
			</div>
			<div class="col-sm-6 col-sm-offset-2 blinds-img">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-4 col-sm-offset-2 shutters">
				...
				<a href="<?php bloginfo('template_url'); ?>/shades"><div class="btn btn-primary red">View all</div></a>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-4 blinds">
				...
				<a href="<?php bloginfo('template_url'); ?>/motorization"><div class="btn btn-primary">View all</div></a>
			</div>
			<div class="col-sm-6 col-sm-offset-2 blinds-img">
